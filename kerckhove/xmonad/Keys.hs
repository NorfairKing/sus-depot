...
myKeys _ = M.fromList $
    [
        ...
        ((mod                                 , xK_braceleft      ),  focusWindowDown         ),
        ((mod                                 , xK_plus           ),  lessWindows             ),
        ((mod                                 , xK_parenleft      ),  focusWindowDown         ),
        ((mod .|. shiftMask                   , xK_parenleft      ),  swapWindowDown          ),
        ((mod                                 , xK_equal          ),  shrinkWindow            ),
        ((mod                                 , xK_asterisk       ),  expandWindow            ),
        ((mod                                 , xK_parenright     ),  focusWindowUp           ),
        ((mod .|. shiftMask                   , xK_parenright     ),  swapWindowUp            ),
        ((mod                                 , xK_exclam         ),  moreWindows             ),
        ((mod                                 , xK_braceright     ),  focusWindowUp           ),
